...
Contact Number: 9876543210
  insert into department values('D01','computer science','dr.anil kumar', 'carmelblock','9876543210');
...
INSERT ALL INTO faculty (faculty_id, faculty_name, qualification, designation, joining_date, salary, email_id, dept_id)
VALUES
('F102','Anand Kumar','PhD','Assistant Professor','03-JUN-2014',75000,'anand@rajagiri.edu','D01')
INTO faculty (faculty_id, faculty_name, qualification, designation, joining_date, salary, email_id, dept_id)
VALUES
('F103','Alan Berly','PhD','Assistant Professor','01-JUN-2014',70000,'alan@rajagiri.edu','D01')
SELECT * FROM dual;
...
Insert a course titled Database Management Systems with four credits for Semester 3.
  insert into course (course_id, course_name, credits, semester) values ('c101','database management system','4','3');
